...
import sys
sys.path.append("../")
from utils.reconstruction_fmnist import visual_shift_cheating_bits_source, visual_shift_cheating_bits_target
import numpy as np
...
class VAEGAN_shift(object):
    def __init__(self, x_source_train, y_source_train,
                 ...
                 x_target_test, y_target_test, y_source_test_transform, y_target_test_transform, nSteps=20000):
        """
        Argument:
        ...
        self.y_source_test_transform = y_source_test_transform
        self.y_target_test_transform = y_target_test_transform
    ...
    def train(self):
        ...
        for step in range(self.nStep):
            ...
            if step % 1000 == 0:
                ...
                accuracy_CB_recon_source_0 = accuracy_score(self.y_source_test.to_numpy().argmax(1),
                                                            Reconstructed_samples_0_source[:, 784:].numpy().argmax(1))
                accuracy_CB_recon_source_1 = accuracy_score(self.y_source_test_transform.argmax(1),
                                                            Reconstructed_samples_1_source[:, 784:].numpy().argmax(1))

                accuracy_CB_recon_target_0 = accuracy_score(self.y_target_test.to_numpy().argmax(1),
                                                            Reconstructed_samples_0_target[:, 784:].numpy().argmax(1))
                accuracy_CB_recon_target_1 = accuracy_score(self.y_target_test_transform.argmax(1),
                                                            Reconstructed_samples_1_target[:, 784:].numpy().argmax(1))

                track_loss = ('Step {} ==> G_Loss: {} C_Loss: {} D_Loss: {}  Recon_Loss: {} \n'
                              'Acc Source: {} Acc Target: {} Acc Domain Source: {}  Acc Domain Target: {} \n'
                              'Acc CB recon source 0: {} Acc CB recon source 1: {}\n'
                              'Acc CB recon target 0: {} Acc CB recon target 1: {}\n').format(step,
                                                                                              g_loss_value.numpy(),
                                                                                              c_loss_value.numpy(),
                                                                                              d_loss_value.numpy(),
                                                                                              ...
                                                                                              accuracy_source,
                                                                                              accuracy_target,
                                                                                              domain_pred_accuracy_source,
                                                                                              domain_pred_accuracy_target,
                                                                                              accuracy_CB_recon_source_0,
                                                                                              accuracy_CB_recon_source_1,
                                                                                              accuracy_CB_recon_target_0,
                                                                                              accuracy_CB_recon_target_1)
                print(track_loss)
                ...
                if step == 9000:
                    ...
                    visual_shift_cheating_bits_source(idx, self.x_source_test, self.y_source_test,
                                                      Reconstructed_samples_0_source, Reconstructed_samples_1_source)

                    # print("Target test data reconstruction")
                    visual_shift_cheating_bits_target(idx, self.x_target_test, self.y_target_test,
                                                      Reconstructed_samples_0_target, Reconstructed_samples_1_target)
