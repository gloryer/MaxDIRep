...
import sys
sys.path.append("../")
from utils.reconstruction_fmnist import visual_random_cheating_bits_source, visual_random_cheating_bits_target
import numpy as np
    ...
    def train(self):
        ...
        for step in range(self.nStep):
            ...
            if step % 1000 == 0:
                ...
                accuracy_CB_recon_source_1 = "N/A"

                accuracy_CB_recon_target_0 = accuracy_score(self.y_source_test.to_numpy().argmax(1),
                                                            Reconstructed_samples_0_target[:, 784:].numpy().argmax(1))
                accuracy_CB_recon_target_1 = "N/A"
                ...
                if step == 9000:
                    ...
                    visual_random_cheating_bits_source(idx, self.x_source_test, self.y_source_test,
                                                       Reconstructed_samples_0_source, Reconstructed_samples_1_source)

                    # print("Target test data reconstruction")
                    visual_random_cheating_bits_target(idx, self.x_target_test, self.y_target_test,
