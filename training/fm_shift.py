...
sys.path.append("../")
from models.fmnist_shift import VAEGAN_shift
from preprocessing.fmnist import load_mnist_shift
...
if __name__ =="__main__":
    ...
    for i in samples:
        ...
        x_source_train, y_source_train, x_target_train_labeled, y_target_train_labeled, \
            ...
            x_target_test, y_target_test, y_source_test_shift, y_target_test_shift = load_mnist_shift(path,
        ...
        model = VAEGAN_shift(x_source_train, y_source_train,
                            ...
                            x_target_test, y_target_test, y_source_test_shift, y_target_test_shift, nSteps=10000)
