...
from models.fmnist import MaxDIRep
...
if __name__ =="__main__":
    ...
    path = "../data/fmnist_upside_down.p"
    ...
    for i in samples: 
        ...
        x_target_test, y_target_test = load_mnist_shift(path, num_target_labeled_samples)
        ...
        stgan = MaxDIRep(x_source_train, y_source_train, 
                    ...
                    x_target_test, y_target_test, nSteps=10000)
