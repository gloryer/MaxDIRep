...
sys.path.append("../")
from models.mnist import VAEGAN_MNIST
from preprocessing.dgits_data import load_svhn_mnist, load_minist


if __name__ =="__main__":
    path_source = "../data/svhn/data_32x32.mat"

    x_source_train, y_source_train, x_source_test, y_source_test = load_svhn_mnist(path_source)
    x_target_train, y_target_train, x_target_test, y_target_test = load_minist()
    ...
    for i in iterations:
        ...
        gan = VAEGAN_MNIST(x_source_train, y_source_train,
