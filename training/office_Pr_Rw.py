...
from models.office_home import MaxDIRepWithDiscriminatorLoss 
...
if __name__ == "__main__":
    ...
    ys = one.fit_transform(yP.reshape(-1, 1))
    ...
    model =MaxDIRepWithDiscriminatorLoss(x_source_train, y_source_train, x_target_train, y_target_train, 
